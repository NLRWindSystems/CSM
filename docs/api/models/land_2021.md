...
.. autoclass:: csm.models.nlr2021.Land2021NLR
    ...
    :exclude-members: turbine_class, rated_power_kw, rotor_diameter, efficiency_max, num_bearings,
        ...
        converter_mass_cost_coeff, converter_cost, converter_power_cost_coeff,
        ...
        get_descendant_attributes, _get_attr_map, get_component_breakdown,
...
| Hub System | `calculate_pitch_system_mass` | Unused in the 2021 model. |
| Hub System | `calculate_pitch_system_cost` | Unused in the 2021 model. |
...
| Nacelle | `calculate_high_speed_shaft_mass` | Unused in the 2020 and later models. |
| Nacelle | `calculate_high_speed_shaft_cost` | Unused in the 2020 and later models. |
