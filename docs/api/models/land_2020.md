...
```{eval-rst}
.. autoclass:: csm.models.nlr2015.Land2020NLR
    :members:
...
The following calculations will override those found in the sections below for shared functionality
...
```{include} ./shared_functionality.md
```
