...
class CSMBase:
    ...
    Args:
        ...
        blade_mass (float): Blade mass (:math:`kg`).
        ...
        lss_mass_intercept (float): :math:`b2` in the low speed shaft mass equation from
            :py:meth:`calculate_low_speed_shaft_mass`.
        lss_mass_cost_coeff (float): Low speed shaft cost per kilogram (:math:`USD/kg`).
        ...
        bearing_mass_exp (bool): :math:`b` in the bearing mass equation from
            :py:meth:`calculate_bearing_mass`.
        bearing_mass_cost_coeff (float): Main bearing cost per kilogram (:math:`USD/kg`).
        ...
        brake_mass_cost_coeff (float): Brake cost per kilogram (:math:`USD/kg`).
        ...
        generator_mass_intercept (bool): :math:`b` in the generator mass equation above (:math:`kg`)
            from :py:meth:`calculate_generator_mass`.
        generator_mass_cost_coeff (float): generator cost per kilogram (:math:`USD/kg`).
        bedplate_mass_exp (bool): :math:`b` in the mass equation from
            :py:meth:`calculate_bedplate_mass`.
        bedplate_mass_cost_coeff (float): bedplate cost per kilogram (:math:`USD/kg`).
        ...
        yaw_system_mass_exp (bool): :math:`b` in the mass equation from
            :py:meth:`calculate_yaw_system_mass`..
        yaw_system_mass_cost_coeff (float): Yaw system cost per kilogram (:math:`USD/kg`).
        ...
        nacelle_mass (float): Total nacelle mass (:math:`kg`). See
        ...
        hub_system_mass (float): Total hub system mass (:math:`kg`). See
            :py:meth:`calculate_hub_system_mass` for more details.
        hub_system_cost (float): Total hub system cost (:math:`USD`). See
            :py:meth:`calculate_hub_system_cost` for more details.
        rotor_mass (float): Total rotor mass (:math:`kg`). See
            :py:meth:`calculate_rotor_mass` for more details.
        rotor_cost (float): Total rotor cost (:math:`USD`). See
            :py:meth:`calculate_rotor_cost` for more details.
        turbine_mass (float): Total turbine mass (:math:`kg`). See
            :py:meth:`calculate_turbine_mass` for more details.
        turbine_cost (float): Total turbine cost (:math:`USD`). See
    ...
    def from_dict(cls, data: dict[str, Any], *, partial: bool = False):
        ...
        Returns:-
            :py:class:`CSMBase`: An instance of :py:class:`CSMBase` or one of its subclasses.
        """
        inputs = set(data)
    ...
    def parameterize_subset(
        ...
        """Run a design loop using a set of control and independent variables as a product of all
        possible parameterized values. Similar to :py:meth:`parameterize` with the exception that
        only the names of the metrics provided in :py:attr:`results` will be calculated to allow for
        partial definitions.

        Note:
            Users are responsible for providing the required inputs to calculate any of the metrics
            provided in :py:attr:`results`.
    ...
    def calculate_hub_cost(self):
        ...
        Args:
            hub_mass_cost_coeff (float): Hub cost per kilogram (:math:`USD/kg`).
            hub_mass (float): Hub mass (:math:`kg`). See :py:meth:`calculate_hub_mass`
                for more details.
    ...
    def calculate_pitch_system_cost(self):
        ...
        Args:
            pitch_system_mass_cost_coeff (float): Pitch system cost per kilogram (:math:`USD/kg`).
            pitch_system_mass (float): Pitch system mass (:math:`kg`). See
                :py:meth:`calculate_pitch_system_mass` for more details.
    ...
    def calculate_spinner_cost(self):
        ...
        Args:
            spinner_mass_cost_coeff (float): Spinner cost per kilogram (:math:`USD/kg`).
            spinner_mass (float): Spinner mass (:math:`kg`). See :py:meth:`calculate_spinner_mass`
                for more details.
    ...
    def calculate_bearing_cost(self):
        ...
        Args:
            bearing_mass_cost_coeff (float): Main bearing cost per kilogram (:math:`USD/kg`).
            bearing_mass (float): Main bearing mass (:math:`kg`). See
                :py:meth:`calculate_bearing_mass` for more details.
    ...
    def calculate_brake_cost(self):
        ...
        Args:
            brake_mass (float): Brake mass (:math:`kg`). See :py:meth:`calculate_brake_mass`
                for more details.
    ...
    def calculate_high_speed_shaft_cost(self):
        ...
        Args:
            high_speed_shaft_mass (float): High speed shaft mass (:math:`kg`). See
    ...
    def calculate_generator_cost(self):
        ...
        Args:
            generator_mass_cost_coeff (float): generator cost per kilogram (:math:`USD/kg`).
            generator_mass (float): generator mass (:math:`kg`). See
                :py:meth:`calculate_generator_mass` for more details.
    ...
    def calculate_bedplate_cost(self):
        ...
        Args:
            ...
            bedplate_mass (float): bedplate mass (:math:`kg`). See
                :py:meth:`calculate_bedplate_mass` for more details.
    ...
    def calculate_yaw_system_cost(self):
        ...
        Args:
            yaw_system_mass_cost_coeff (float): Yaw system cost per kilogram (:math:`USD/kg`).
            yaw_system_mass (float): Yaw system mass (:math:`kg`).
    ...
    def calculate_nacelle_cover_cost(self):
        ...
        Args:
            nacelle_cover_mass_cost_coeff (float): Nacelle cover cost per kilogram (:math:`USD/kg`).
            nacelle_cover_mass (float): Nacelle cover mass (:math:`kg`). See
                :py:meth:`calculate_nacelle_cover_mass` for more details.
    ...
    def calculate_transformer_cost(self):
        ...
        Args:
            transformer_mass_cost_coeff (float): Transformer cost per kilogram (:math:`USD/kg`).
            transformer_mass (float): Transformer mass (:math:`kg`). See
                :py:meth:`calculate_transformer_mass` for more details.
    ...
    def calculate_tower_cost(self):
        ...
        Args:
            tower_mass_cost_coeff (float): Tower cost per kilogram (:math:`USD/kg`).
            tower_mass (float): Tower mass (:math:`kg`). See
                :py:meth:`calculate_tower_mass` for more details.
    ...
    def calculate_hub_system_cost(self):
        """Calculates and sets :py:attr:`hub_system_cost`  (:math:`USD`) if it was not provided by
        the user.
